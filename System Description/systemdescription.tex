...
\begin{itemize}
    ...
    \item Since the backup is pulled from other machines, all relevant configuration and administration can easiyl be done on a single machine which follows the security principles of \emph{Usability} and \emph{Compartmentalization}.
    ...
    \item Using SSH to encrypt data in transit to the backup machine adheres to security principles
\end{itemize}
