...
\item \textbf{Web application}: Runs CentOS 7, nginx, uWSGI and a Django application that was developed by a contractor. The software is updated regularly by the system administrator with occasional support of the contractor. 
