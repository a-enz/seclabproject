...
\newcolumntype{L}{lp{0.25\textwidth}p{0.25\textwidth}lll}
...
\hline
1 & Expert Hackers: mount MitM attack to spy and tamper communications between Clients and Web Server. This allows the Hackers to learn in particular User's password and private keys. & HTTPs connection with Server side authentication & {\it Medium} & {\it High} & {\it Medium} \\
\hline
...
No. & Threat &  Countermeasure(s) & L & I & Risk \\
\hline
1 & User: exploits physical access to Backup Machine and obtains backup data. & Physical protection of System's Components, Disk Encryption & {\it Low} & {\it Medium} & {\it Low} \\
\hline
\end{prettytablex}
\end{footnotesize}
...
No. & Threat &  Countermeasure(s) & L & I & Risk \\
\hline
1 & Expert Hacker: steals System's Administrator credentials & Enforce Strong Passwords, Increase security sensibilization/awareness & {\it Medium} & {\it High} & {\it Medium} \\
\hline
2 & Organizatorial Deficiencies: illness or injury impede its work and the System is left unattended in case of problems/attacks &  & {\it High} & {\it Medium} & {\it Medium} \\
\hline
\end{prettytablex}
\end{footnotesize}
